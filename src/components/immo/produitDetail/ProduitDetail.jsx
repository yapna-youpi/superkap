                  ...
                  <div className="row">
                    <div className="col">
                      <div className="row ">
                          ...
                          <div className="col .col-md-6 p-fot3"><img src={maison2} alt="maison2" /></div>
                      </div>
                      <div className="row">
                          <div className="col .col-md-6 p-fot4"><img src={maison3} alt="maison3" /></div>
                          <div className="col .col-md-6 p-fot5"><img src={maison4} alt="maison4" /></div>
                      </div>
                    </div>
                  </div>  
                </div>
