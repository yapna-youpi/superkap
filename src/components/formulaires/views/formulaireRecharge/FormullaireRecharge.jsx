    ...
    return (
        <div className='formulaireI w-100 mt-5 pt-5'>
            <h6 className='text-success d-block mx-5 px-5'>
                <i className="bx bxs-right-arrow-alt get-started-icon-card">< MdOutlineKeyboardBackspace /></i> <span className='fs-5'>Retour</span>
            </h6>
                    ...
                    <div className='formu-content mt-4 d-flex justify-content-around'>
                        <div className="formu-left">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="boite_postale" class="form-control input-buy" placeholder="Boite Postale" required />
                            </div>
                        </div>
