...
function FormullaireImmo({ User }) {
    ...
    const handleSubmit=(e)=>{
        ...
        let params={
            ...
            adresse: state.adresse, profession: state.proffession, operation_type: 'Commande'
        }
  ...
  return (
      <div className='formulaireI w-100 mt-5 py-5'>
                <h6  className='text-success d-block my-3 mx-auto px-5 w-75'>
                    <i onClick={()=>history.push('/Carte')} className="bx bxs-right-arrow-alt get-started-icon-card txte">< MdOutlineKeyboardBackspace /></i> 
                    <span onClick={()=>history.push('/Carte')} className='fs-5 txte'>&nbsp; Retour</span>
                </h6>
            <div className="formulaire-content ">
                <form className='bg-light w-75 mx-auto formu' onSubmit={(e)=>handleSubmit(e)}>
                    ...
                    <div className='formu-content mt-4 d-flex justify-content-around row'>
                        <div className="formu-left col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text"  name="Prénom" class="form-control input-buy" placeholder="Prénom" />
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text"  name="Code Postale" class="form-control input-buy" placeholder="Code Postale"  />
                            </div>
                        </div>
...
export default connect(mapStateToProps)(FormullaireImmo)
