        ...
        <div>
            <div className="home-immo shadow container my-5 pb-3">
                ...
                <div className="row d-flex justify-content-around">
                    <div onClick={()=>history.push('/Immo')} className="col-11  immo-card2 col-md-5 p-5">
                        <h4 className='.h-immo-content'>profiter au maximum de ces lieux empreints de sérénité</h4>
                    </div>
                    <div onClick={()=>history.push('/Immo')} className="col-11 mt-5  mt-md-0 immo-card1 col-md-5 p-5">
                        <h4 className='.h-immo-content'>un appartement,une destination ideale pour votre prochain séjour</h4>
                    </div>
                </div>
                 <div className="row">
                     <div onClick={()=>history.push('/Immo')} className="btn btn-lg bg-info w-50 my-5 mx-auto">Voir Plus De Maison </div>
                 </div>
            </div>
        </div>
    )
