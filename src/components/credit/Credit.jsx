        ...
        <div className='sk-credit'>
            ...
            <div className="command">
                ...
                <div className="container command-body ">
                    <h1>Notre carte VISA BSIC</h1>
                    <p>La carte visa prépayée rechargeable BSIC est un support qui permet de retirer, payer sur internet et TPE des achats pour un montant défini à l'avance. </p>
                    ...
                    <div className="row">
                        ...
                        <div className="col .col-md-6 fs-5">
                            <p className=''>
                                ...
                                La carte Visa prépayée BSIC favorise la tranquillité d’esprit en 
                                limitant votre exposition aux fraudes bancaires.
                            </p>
                            <p>
                            Cette carte internationale VISA est en formule PRÉPAYÉE et est 
